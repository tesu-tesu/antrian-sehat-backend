...
class CreateWaitingListViews extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement(
            ...
            h.name health_agency, (wl.order_number - order_number) distance_number,
                ...
                COALESCE(
                    ...
                    GROUP BY x.status HAVING x.status = 'Belum Diperiksa'), 0) current_number
